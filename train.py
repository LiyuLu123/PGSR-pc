...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    # pcd_path = os.path.join(dataset.source_path, "train_pcds")
    # # print(pcd_path )
    # # exit()
    # if first_iter == 0:
    #     if hasattr():
    ...
    #         gaussians.create_from_pcd(init_pcd)  # 填充高斯参数
    #     else:
    #         print("no pcd")
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        # if hasattr(viewpoint_cam, 'pcd_path'):
        #     current_pcd = o3d.io.read_point_cloud(viewpoint_cam.pcd_path)
        #     gaussians.update_with_pcd(current_pcd)
        # print('pcd_path')
        # exit()
        ...
        if iteration > opt.multi_view_weight_from_iter:
            ...
            if nearest_cam is not None:
                ...
                # image2pc_path=viewpoint_cam.image_path
                # filename = os.path.basename(image2pc_path)
                # timestamp_str = os.path.splitext(filename)[0]
                # pc_path = os.path.join(dataset.source_path,"train_pcds",f"{timestamp_str}_cam.pcd")
                # # print(pc_path)
                # pts = o3d.io.read_point_cloud(pc_path)
                # print(pts)
                # exit()
...
if __name__ == "__main__":
    ...
    #parser.add_argument('--pc', type=str, default=None, help='Path to the point cloud file for initialization')
